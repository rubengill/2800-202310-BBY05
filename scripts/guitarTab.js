...
//---rubens code, puts all songs in one thing
// firebase.auth().onAuthStateChanged(async (user) => {
//     if (user) {
//         // Use user's UID here
//         const uid = user.uid;
...
//         db.collection('users').doc(uid).collection('songs').get().then((querySnapshot) => {
//             console.log("****** querySnapshot from guitarTab.js:" + querySnapshot + "**********");
//             console.log("******current song from guitarTab.js:" + querySnapshot[currentTask] + "**********");
